...
# {
#   death_number_path = paste("https://www.ipss.go.jp/p-toukei/JMD/", region, "/STATS/",   "Deaths_1x1.txt", sep = "")
#   death_number_data = data.table::fread(death_number_path, skip = 2, header = TRUE, data.table = F, blank.lines.skip = T)
...
#   return(list(Deaths = death_number_data, pop = exposure_data))
# }

read.jpn_death <- function(region, label = region, save_path = "cache") {
  # Ensure save_path directory exists
  dir.create(save_path, recursive = TRUE, showWarnings = FALSE)
  
  # Define file paths for saving the downloaded data
  death_number_file <- file.path(save_path, paste0(region, "_Deaths_1x1.csv"))
  exposure_file <- file.path(save_path, paste0(region, "_Exposures_1x1.csv"))
  
  # Load or download the death number data
  if (!file.exists(death_number_file)) {
    death_number_url <- paste0("https://www.ipss.go.jp/p-toukei/JMD/", region, "/STATS/", "Deaths_1x1.txt")
    death_number_data <- data.table::fread(death_number_url, skip = 2, header = TRUE, data.table = FALSE, blank.lines.skip = TRUE)
    write.csv(death_number_data, death_number_file, row.names = FALSE)
  } else {
    death_number_data <- read.csv(death_number_file)
  }
  
  # Load or download the exposure data
...
Hokkaido_count_F = matrix(dum[1:values,3], nrow=111)
Hokkaido_count_M = matrix(dum[1:values,4], nrow=111)
Hokkaido_count_T = matrix(dum[1:values,5], nrow=111)
...
Aomori_count_F = matrix(dum[1:values,3], nrow=111)
Aomori_count_M = matrix(dum[1:values,4], nrow=111)
Aomori_count_T = matrix(dum[1:values,5], nrow=111)
...
Iwate_count_F = matrix(dum[1:values,3], nrow=111)
Iwate_count_M = matrix(dum[1:values,4], nrow=111)
Iwate_count_T = matrix(dum[1:values,5], nrow=111)
...
Miyagi_count_F = matrix(dum[1:values,3], nrow=111)
Miyagi_count_M = matrix(dum[1:values,4], nrow=111)
Miyagi_count_T = matrix(dum[1:values,5], nrow=111)
...
Akita_count_F = matrix(dum[1:values,3], nrow=111)
Akita_count_M = matrix(dum[1:values,4], nrow=111)
Akita_count_T = matrix(dum[1:values,5], nrow=111)
...
Yamagata_count_F = matrix(dum[1:values,3], nrow=111)
Yamagata_count_M = matrix(dum[1:values,4], nrow=111)
Yamagata_count_T = matrix(dum[1:values,5], nrow=111)
...
Fukushima_count_F = matrix(dum[1:values,3], nrow=111)
Fukushima_count_M = matrix(dum[1:values,4], nrow=111)
Fukushima_count_T = matrix(dum[1:values,5], nrow=111)
...
Ibaraki_count_F = matrix(dum[1:values,3], nrow=111)
Ibaraki_count_M = matrix(dum[1:values,4], nrow=111)
Ibaraki_count_T = matrix(dum[1:values,5], nrow=111)
...
Tochigi_count_F = matrix(dum[1:values,3], nrow=111)
Tochigi_count_M = matrix(dum[1:values,4], nrow=111)
Tochigi_count_T = matrix(dum[1:values,5], nrow=111)
...
Gunma_count_F = matrix(dum[1:values,3], nrow=111)
Gunma_count_M = matrix(dum[1:values,4], nrow=111)
Gunma_count_T = matrix(dum[1:values,5], nrow=111)
...
Saitama_count_F = matrix(dum[1:values,3], nrow=111)
Saitama_count_M = matrix(dum[1:values,4], nrow=111)
Saitama_count_T = matrix(dum[1:values,5], nrow=111)
...
Chiba_count_F = matrix(dum[1:values,3], nrow=111)
Chiba_count_M = matrix(dum[1:values,4], nrow=111)
Chiba_count_T = matrix(dum[1:values,5], nrow=111)
...
Tokyo_count_F = matrix(dum[1:values,3], nrow=111)
Tokyo_count_M = matrix(dum[1:values,4], nrow=111)
Tokyo_count_T = matrix(dum[1:values,5], nrow=111)
...
Kanagawa_count_F = matrix(dum[1:values,3], nrow=111)
Kanagawa_count_M = matrix(dum[1:values,4], nrow=111)
Kanagawa_count_T = matrix(dum[1:values,5], nrow=111)
...
Niigata_count_F = matrix(dum[1:values,3], nrow=111)
Niigata_count_M = matrix(dum[1:values,4], nrow=111)
Niigata_count_T = matrix(dum[1:values,5], nrow=111)
...
Toyama_count_F = matrix(dum[1:values,3], nrow=111)
Toyama_count_M = matrix(dum[1:values,4], nrow=111)
Toyama_count_T = matrix(dum[1:values,5], nrow=111)
...
Ishikawa_count_F = matrix(dum[1:values,3], nrow=111)
Ishikawa_count_M = matrix(dum[1:values,4], nrow=111)
Ishikawa_count_T = matrix(dum[1:values,5], nrow=111)
...
Fukui_count_F = matrix(dum[1:values,3], nrow=111)
Fukui_count_M = matrix(dum[1:values,4], nrow=111)
Fukui_count_T = matrix(dum[1:values,5], nrow=111)
...
Yamanashi_count_F = matrix(dum[1:values,3], nrow=111)
Yamanashi_count_M = matrix(dum[1:values,4], nrow=111)
Yamanashi_count_T = matrix(dum[1:values,5], nrow=111)
...
Nagano_count_F = matrix(dum[1:values,3], nrow=111)
Nagano_count_M = matrix(dum[1:values,4], nrow=111)
Nagano_count_T = matrix(dum[1:values,5], nrow=111)
...
Gifu_count_F = matrix(dum[1:values,3], nrow=111)
Gifu_count_M = matrix(dum[1:values,4], nrow=111)
Gifu_count_T = matrix(dum[1:values,5], nrow=111)
...
Shizuoka_count_F = matrix(dum[1:values,3], nrow=111)
Shizuoka_count_M = matrix(dum[1:values,4], nrow=111)
Shizuoka_count_T = matrix(dum[1:values,5], nrow=111)
...
Aichi_count_F = matrix(dum[1:values,3], nrow=111)
Aichi_count_M = matrix(dum[1:values,4], nrow=111)
Aichi_count_T = matrix(dum[1:values,5], nrow=111)
...
Mie_count_F = matrix(dum[1:values,3], nrow=111)
Mie_count_M = matrix(dum[1:values,4], nrow=111)
Mie_count_T = matrix(dum[1:values,5], nrow=111)
...
Shiga_count_F = matrix(dum[1:values,3], nrow=111)
Shiga_count_M = matrix(dum[1:values,4], nrow=111)
Shiga_count_T = matrix(dum[1:values,5], nrow=111)
...
Kyoto_count_F = matrix(dum[1:values,3], nrow=111)
Kyoto_count_M = matrix(dum[1:values,4], nrow=111)
Kyoto_count_T = matrix(dum[1:values,5], nrow=111)
...
Osaka_count_F = matrix(dum[1:values,3], nrow=111)
Osaka_count_M = matrix(dum[1:values,4], nrow=111)
Osaka_count_T = matrix(dum[1:values,5], nrow=111)
...
Hyogo_count_F = matrix(dum[1:values,3], nrow=111)
Hyogo_count_M = matrix(dum[1:values,4], nrow=111)
Hyogo_count_T = matrix(dum[1:values,5], nrow=111)
...
Nara_count_F = matrix(dum[1:values,3], nrow=111)
Nara_count_M = matrix(dum[1:values,4], nrow=111)
Nara_count_T = matrix(dum[1:values,5], nrow=111)
...
Wakayama_count_F = matrix(dum[1:values,3], nrow=111)
Wakayama_count_M = matrix(dum[1:values,4], nrow=111)
Wakayama_count_T = matrix(dum[1:values,5], nrow=111)
...
Tottori_count_F = matrix(dum[1:values,3], nrow=111)
Tottori_count_M = matrix(dum[1:values,4], nrow=111)
Tottori_count_T = matrix(dum[1:values,5], nrow=111)
...
Shimane_count_F = matrix(dum[1:values,3], nrow=111)
Shimane_count_M = matrix(dum[1:values,4], nrow=111)
Shimane_count_T = matrix(dum[1:values,5], nrow=111)
...
Okayama_count_F = matrix(dum[1:values,3], nrow=111)
Okayama_count_M = matrix(dum[1:values,4], nrow=111)
Okayama_count_T = matrix(dum[1:values,5], nrow=111)
...
Hiroshima_count_F = matrix(dum[1:values,3], nrow=111)
Hiroshima_count_M = matrix(dum[1:values,4], nrow=111)
Hiroshima_count_T = matrix(dum[1:values,5], nrow=111)
...
Yamaguchi_count_F = matrix(dum[1:values,3], nrow=111)
Yamaguchi_count_M = matrix(dum[1:values,4], nrow=111)
Yamaguchi_count_T = matrix(dum[1:values,5], nrow=111)
...
Tokushima_count_F = matrix(dum[1:values,3], nrow=111)
Tokushima_count_M = matrix(dum[1:values,4], nrow=111)
Tokushima_count_T = matrix(dum[1:values,5], nrow=111)
...
Kagawa_count_F = matrix(dum[1:values,3], nrow=111)
Kagawa_count_M = matrix(dum[1:values,4], nrow=111)
Kagawa_count_T = matrix(dum[1:values,5], nrow=111)
...
Ehime_count_F = matrix(dum[1:values,3], nrow=111)
Ehime_count_M = matrix(dum[1:values,4], nrow=111)
Ehime_count_T = matrix(dum[1:values,5], nrow=111)
...
Kochi_count_F = matrix(dum[1:values,3], nrow=111)
Kochi_count_M = matrix(dum[1:values,4], nrow=111)
Kochi_count_T = matrix(dum[1:values,5], nrow=111)
...
Fukuoka_count_F = matrix(dum[1:values,3], nrow=111)
Fukuoka_count_M = matrix(dum[1:values,4], nrow=111)
Fukuoka_count_T = matrix(dum[1:values,5], nrow=111)
...
Saga_count_F = matrix(dum[1:values,3], nrow=111)
Saga_count_M = matrix(dum[1:values,4], nrow=111)
Saga_count_T = matrix(dum[1:values,5], nrow=111)
...
Nagasaki_count_F = matrix(dum[1:values,3], nrow=111)
Nagasaki_count_M = matrix(dum[1:values,4], nrow=111)
Nagasaki_count_T = matrix(dum[1:values,5], nrow=111)
...
Kumamoto_count_F = matrix(dum[1:values,3], nrow=111)
Kumamoto_count_M = matrix(dum[1:values,4], nrow=111)
Kumamoto_count_T = matrix(dum[1:values,5], nrow=111)
...
Oita_count_F = matrix(dum[1:values,3], nrow=111)
Oita_count_M = matrix(dum[1:values,4], nrow=111)
Oita_count_T = matrix(dum[1:values,5], nrow=111)
...
Miyazaki_count_F = matrix(dum[1:values,3], nrow=111)
Miyazaki_count_M = matrix(dum[1:values,4], nrow=111)
Miyazaki_count_T = matrix(dum[1:values,5], nrow=111)
...
Kagoshima_count_F = matrix(dum[1:values,3], nrow=111)
Kagoshima_count_M = matrix(dum[1:values,4], nrow=111)
Kagoshima_count_T = matrix(dum[1:values,5], nrow=111)
...
Okinawa_count_F = matrix(dum[1:values,3], nrow=111)
Okinawa_count_M = matrix(dum[1:values,4], nrow=111)
Okinawa_count_T = matrix(dum[1:values,5], nrow=111)
...
mfts_R2_rate_summary = cbind(rep(year_start:year_end,101), rep(0:100,years), as.numeric(mfts_R2_female_rate), as.numeric(mfts_R2_male_rate), as.numeric(mfts_R2_total_rate))
colnames(mfts_R2_rate_summary) = c("Year","Age","Female","Male","Total")
write.table(mfts_R2_rate_summary, paste0(region_dir, "mfts_R2_rate.txt"), quote = FALSE, row.names=FALSE, col.names=TRUE)

mfts_R2_count_summary = cbind(rep(year_start:year_end,101), rep(0:100,years), as.numeric(mfts_R2_female_count), as.numeric(mfts_R2_male_count), as.numeric(mfts_R2_total_count))
colnames(mfts_R2_count_summary) = c("Year","Age","Female","Male","Total")
write.table(mfts_R2_count_summary, paste0(region_dir, "mfts_R2_count.txt"), quote = FALSE, row.names=FALSE, col.names=TRUE)

mfts_R2 = read.demogdata(paste0(region_dir, "mfts_R2_rate.txt"), paste0(region_dir, "mfts_R2_count.txt"), type="mortality", label = "R2", skip=0)
...
mfts_R3_rate_summary = cbind(rep(year_start:year_end, 101), rep(0:100, years), as.numeric(mfts_R3_female_rate), as.numeric(mfts_R3_male_rate), as.numeric(mfts_R3_total_rate))
colnames(mfts_R3_rate_summary) = c("Year", "Age", "Female", "Male", "Total")
write.table(mfts_R3_rate_summary, paste0(region_dir, "mfts_R3_rate.txt"), quote = FALSE, row.names = FALSE, col.names = TRUE)

mfts_R3_count_summary = cbind(rep(year_start:year_end, 101), rep(0:100, years), as.numeric(mfts_R3_female_count), as.numeric(mfts_R3_male_count), as.numeric(mfts_R3_total_count))
colnames(mfts_R3_count_summary) = c("Year", "Age", "Female", "Male", "Total")
write.table(mfts_R3_count_summary, paste0(region_dir, "mfts_R3_count.txt"), quote = FALSE, row.names = FALSE, col.names = TRUE)

mfts_R3 = read.demogdata(paste0(region_dir, "mfts_R3_rate.txt"), paste0(region_dir, "mfts_R3_count.txt"), type = "mortality", label = "R3", skip = 0)
...
mfts_R4_rate_summary = cbind(rep(year_start:year_end, 101), rep(0:100, years), as.numeric(mfts_R4_female_rate), as.numeric(mfts_R4_male_rate), as.numeric(mfts_R4_total_rate))
colnames(mfts_R4_rate_summary) = c("Year", "Age", "Female", "Male", "Total")
write.table(mfts_R4_rate_summary, paste0(region_dir, "mfts_R4_rate.txt"), quote = FALSE, row.names = FALSE, col.names = TRUE)

mfts_R4_count_summary = cbind(rep(year_start:year_end, 101), rep(0:100, years), as.numeric(mfts_R4_female_count), as.numeric(mfts_R4_male_count), as.numeric(mfts_R4_total_count))
colnames(mfts_R4_count_summary) = c("Year", "Age", "Female", "Male", "Total")
write.table(mfts_R4_count_summary, paste0(region_dir, "mfts_R4_count.txt"), quote = FALSE, row.names = FALSE, col.names = TRUE)

mfts_R4 = read.demogdata(paste0(region_dir, "mfts_R4_rate.txt"), paste0(region_dir, "mfts_R4_count.txt"), type = "mortality", label = "R4", skip = 0)
...
mfts_R5_rate_summary = cbind(rep(year_start:year_end, 101), rep(0:100, years), as.numeric(mfts_R5_female_rate), as.numeric(mfts_R5_male_rate), as.numeric(mfts_R5_total_rate))
colnames(mfts_R5_rate_summary) = c("Year", "Age", "Female", "Male", "Total")
write.table(mfts_R5_rate_summary, paste0(region_dir, "mfts_R5_rate.txt"), quote = FALSE, row.names = FALSE, col.names = TRUE)

mfts_R5_count_summary = cbind(rep(year_start:year_end, 101), rep(0:100, years), as.numeric(mfts_R5_female_count), as.numeric(mfts_R5_male_count), as.numeric(mfts_R5_total_count))
colnames(mfts_R5_count_summary) = c("Year", "Age", "Female", "Male", "Total")
write.table(mfts_R5_count_summary, paste0(region_dir, "mfts_R5_count.txt"), quote = FALSE, row.names = FALSE, col.names = TRUE)

mfts_R5 = read.demogdata(paste0(region_dir, "mfts_R5_rate.txt"), paste0(region_dir, "mfts_R5_count.txt"), type = "mortality", label = "R5", skip = 0)
...
mfts_R6_rate_summary = cbind(rep(year_start:year_end, 101), rep(0:100, years), as.numeric(mfts_R6_female_rate), as.numeric(mfts_R6_male_rate), as.numeric(mfts_R6_total_rate))
colnames(mfts_R6_rate_summary) = c("Year", "Age", "Female", "Male", "Total")
write.table(mfts_R6_rate_summary, paste0(region_dir, "mfts_R6_rate.txt"), quote = FALSE, row.names = FALSE, col.names = TRUE)

mfts_R6_count_summary = cbind(rep(year_start:year_end, 101), rep(0:100, years), as.numeric(mfts_R6_female_count), as.numeric(mfts_R6_male_count), as.numeric(mfts_R6_total_count))
colnames(mfts_R6_count_summary) = c("Year", "Age", "Female", "Male", "Total")
write.table(mfts_R6_count_summary, paste0(region_dir, "mfts_R6_count.txt"), quote = FALSE, row.names = FALSE, col.names = TRUE)

mfts_R6 = read.demogdata(paste0(region_dir, "mfts_R6_rate.txt"), paste0(region_dir, "mfts_R6_count.txt"), type = "mortality", label = "R6", skip = 0)
...
mfts_R7_rate_summary = cbind(rep(year_start:year_end, 101), rep(0:100, years), as.numeric(mfts_R7_female_rate), as.numeric(mfts_R7_male_rate), as.numeric(mfts_R7_total_rate))
colnames(mfts_R7_rate_summary) = c("Year", "Age", "Female", "Male", "Total")
write.table(mfts_R7_rate_summary, paste0(region_dir, "mfts_R7_rate.txt"), quote = FALSE, row.names = FALSE, col.names = TRUE)

mfts_R7_count_summary = cbind(rep(year_start:year_end, 101), rep(0:100, years), as.numeric(mfts_R7_female_count), as.numeric(mfts_R7_male_count), as.numeric(mfts_R7_total_count))
colnames(mfts_R7_count_summary) = c("Year", "Age", "Female", "Male", "Total")
write.table(mfts_R7_count_summary, paste0(region_dir, "mfts_R7_count.txt"), quote = FALSE, row.names = FALSE, col.names = TRUE)

mfts_R7 = read.demogdata(paste0(region_dir, "mfts_R7_rate.txt"), paste0(region_dir, "mfts_R7_count.txt"), type = "mortality", label = "R7", skip = 0)
...
mfts_R8_female_rate = (Fukuoka_count_female + Saga_count_female + Nagasaki_count_female + Kumamoto_count_female + 
                         Oita_count_female + Miyazaki_count_female + Kagoshima_count_female + Okinawa_count_female)/mfts_R8_female_count
...
mfts_R8_rate_summary = cbind(rep(year_start:year_end, 101), rep(0:100, years), as.numeric(mfts_R8_female_rate), as.numeric(mfts_R8_male_rate), as.numeric(mfts_R8_total_rate))
colnames(mfts_R8_rate_summary) = c("Year", "Age", "Female", "Male", "Total")
write.table(mfts_R8_rate_summary, paste0(region_dir, "mfts_R8_rate.txt"), quote = FALSE, row.names = FALSE, col.names = TRUE)

mfts_R8_count_summary = cbind(rep(year_start:year_end, 101), rep(0:100, years), as.numeric(mfts_R8_female_count), as.numeric(mfts_R8_male_count), as.numeric(mfts_R8_total_count))
colnames(mfts_R8_count_summary) = c("Year", "Age", "Female", "Male", "Total")
write.table(mfts_R8_count_summary, paste0(region_dir, "mfts_R8_count.txt"), quote = FALSE, row.names = FALSE, col.names = TRUE)

mfts_R8 = read.demogdata(paste0(region_dir, "mfts_R8_rate.txt"), paste0(region_dir, "mfts_R8_count.txt"), type = "mortality", label = "R8", skip = 0)
...
# total_comb = total_comb_pop =  matrix(NA, 101*47, 47)
# for(iw in 2:48)
# {
#   total_comb[,iw-1] = as.numeric(get(state[iw])$rate$total)
#   total_comb_pop[,iw-1] = as.numeric(get(state[iw])$pop$total)
# }
# total_comb_v2 = cbind(rep(1975:2021, each=101), rep(0:100, 47), total_comb)
# total_comb_pop_v2 = cbind(rep(1975:2021, each=101), rep(0:100, 47), total_comb_pop)
# colnames(total_comb_v2) = colnames(total_comb_pop_v2) = c("Year", "Age", state[2:48])

total_comb = total_comb_pop = matrix(NA, 101 * years, 47)
for (iw in 2:48) {
  total_comb[, iw - 1] = as.numeric(get(state[iw])$rate$total)
  total_comb_pop[, iw - 1] = as.numeric(get(state[iw])$pop$total)
}

# Update year sequences to use the dynamic `years` variable
total_comb_v2 = cbind(rep(year_start:year_end, each = 101), rep(0:100, years), total_comb)
total_comb_pop_v2 = cbind(rep(year_start:year_end, each = 101), rep(0:100, years), total_comb_pop)
colnames(total_comb_v2) = colnames(total_comb_pop_v2) = c("Year", "Age", state[2:48])
...
# total_region_comb = total_region_comb_pop = matrix(NA, 101*47, 8)
# for(iw in 1:8)
# {
#   total_region_comb[,iw] = as.numeric(get(region[iw])$rate$total)
#   total_region_comb_pop[,iw] = as.numeric(get(region[iw])$pop$total)
# }
# total_region_comb_v2 = cbind(rep(1975:2021, each=101), rep(0:100, 47), total_region_comb)
# total_region_comb_pop_v2 = cbind(rep(1975:2021, each=101), rep(0:100, 47), total_region_comb_pop)
# colnames(total_region_comb_v2) = colnames(total_region_comb_pop_v2) = c("Year", "Age", region)

total_region_comb = total_region_comb_pop = matrix(NA, 101 * years, 8)
for (iw in 1:8) {
  total_region_comb[, iw] = as.numeric(get(region[iw])$rate$total)
  total_region_comb_pop[, iw] = as.numeric(get(region[iw])$pop$total)
}

# Update year sequences for region-level data
total_region_comb_v2 = cbind(rep(year_start:year_end, each = 101), rep(0:100, years), total_region_comb)
total_region_comb_pop_v2 = cbind(rep(year_start:year_end, each = 101), rep(0:100, years), total_region_comb_pop)
colnames(total_region_comb_v2) = colnames(total_region_comb_pop_v2) = c("Year", "Age", region)